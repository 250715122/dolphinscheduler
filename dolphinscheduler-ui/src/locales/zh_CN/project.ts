...
export default {
  ...
  workflow: {
    ...
    view_as_list: '列表视图',
    batch_group: '批量分组',
    batch_group_placeholder: '选择已有分组，或输入新分组名后回车',
    batch_group_required: '请选择或输入业务分组',
    batch_group_empty: '请先勾选工作流',
    batch_group_tip: '将把已选工作流归入指定业务分组（可选用已有分组，也可输入新分组）',
    schedule_none: '无定时',
    reset: '重置',
    query: '查询',
    group_source_manual: '手动分组',
    group_source_rule: '规则匹配',
    group_source_prefix: '名称前缀',
    ungrouped: '未分组',
    relation_biz_group: '业务分组',
    relation_no_permission_title: '无项目访问权限',
    relation_no_permission_desc: '当前账号无权访问该项目的工作流关系，请联系管理员授权。',
    relation_close: '关闭',
    relation_title: '工作流依赖关系',
    relation_external_edge: '跨项目 · {project}',
    relation_external_short: '其它项目：{project}',
    relation_external_project: '其它项目',
    relation_focus_hint: '双击节点可聚焦上下游链路',
    relation_toggle_filter: '筛选',
    relation_fit_view: '适应画布',
    relation_depth_3: '三跳上下游',
    relation_publish_status: '发布状态',
    relation_impact_summary: '上游 {up} · 下游影响 {down}',
    relation_impact_hint: '在拓扑或时间线中选择一个工作流后，这里会展示完整上下游影响范围。',
    relation_view_impact: '影响分析',
    relation_mode_lineage_soon: '数据血缘 / 混合视图将接入表级血缘模型，当前仍以工作流依赖关系为主。',
    relation_mode_hybrid: '混合视图',
    relation_mode_lineage: '数据血缘',
    relation_mode_workflow: '工作流依赖',
    relation_subtitle: '看全局、查单点、追上下游、看时间与影响范围（工作流即表加工链路）',
    relation_filter_collapse: '收起',
    relation_filters: '筛选与视图',
    relation_search: '搜索',
    relation_prefix: '名称前缀',

    relation_level: '依赖层级',
    relation_level_root: '源头',
    relation_timeline_axis: '当日时刻',
    relation_timeline_no_cron: '无调度',
    relation_layer: '名称前缀',
    relation_status: '状态',
    relation_depth: '关系深度',
    relation_depth_self: '仅自己',
    relation_depth_1: '一跳上下游',
    relation_depth_2: '两跳上下游',
    relation_depth_all: '全链路',
    relation_only_isolated: '仅看孤立节点',
    relation_detail: '工作流详情',
    relation_detail_empty: '请选择一个工作流查看详情与上下游影响。',
    relation_basic: '基本信息',
    relation_upstream: '上游',
    relation_downstream: '下游',
    relation_none: '无',
    relation_actions: '快捷操作',
    relation_goto_definition: '查看定义',
    relation_goto_instances: '查看实例',
    relation_goto_impact: '影响分析',
    relation_back_detail: '返回详情',
    relation_view_topology: '拓扑视图',
    relation_view_timeline: '时间线视图',
    relation_metric_nodes: '工作流',
  ...
  node: {
    ...
    sql_check_name: '检查名称',
    sql_check_name_tips: '可选，便于告警与列表识别',
    sql_check_sql: '对比 SQL（返回单行单列数值）',
    sql_check_operator: '失败条件运算符',
    sql_check_threshold: '阈值',
    sql_check_threshold_tips: '当 实际值 运算符 阈值 为真时任务失败',
    sql_check: '数据质量检查',
  ...
  preference: {
    cancel: '取消',
    group_color: '颜色',
    group_color_preset_hint: '从 8 种常用色中选择，便于保持一致',
    group_catalog_title: '业务分组',
    submit_task_only_hint: '上方「提交」仅保存任务默认偏好（优先级、租户、Worker 等）',
    group_save_failed: '业务分组设置保存失败',
    group_saved: '业务分组设置已保存',
    group_autosave_hint: '分组相关修改将立即保存',
    group_saving: '保存中…',
    group_auto_match_hint: '仅对尚未手动归组的工作流生效。关闭后这类工作流显示为未分组。',
    group_auto_match_off: '关',
    group_auto_match_on: '开',
    group_auto_match_label: '启用自动匹配',
    group_catalog_hint: '在此增删改查本项目的业务分组。工作流手动归组与匹配规则都引用这里的分组名。归组优先级：手动分组 → 规则匹配 → 名称前缀。',
    group_catalog_empty: '暂无业务分组，请先新增或载入示例',
    group_add: '新增分组',
    group_edit: '编辑',
    group_load_defaults: '载入示例分组',
    group_sync_done: '已同步，当前共 {n} 个分组',
    group_sync_existing: '同步已有分组名',
    group_search: '搜索分组名/说明',
    group_desc: '说明',
    group_desc_placeholder: '可选：用途说明',
    group_actions: '操作',
    group_name_required: '请填写分组名',
    group_name_duplicate: '分组名已存在',
    group_delete_confirm_title: '删除业务分组',
    group_delete_confirm: '确定删除分组「{name}」？将同时清理引用该分组的规则与手动覆盖。',
    group_rules_need_catalog: '请先在上方维护业务分组，再配置匹配规则',
    group_rules_title: '分组自动匹配规则',
    group_rules_hint: '打开开关后：无手动分组的工作流按下方规则匹配；关闭后：无手动分组则不分组。规则修改后立即保存。',
    group_manual_hint: '手动分组：① 工作流列表「批量归组」；② 描述中写 [group:运维] 或 #group:运维。',
    group_rule_add: '新增规则',
    group_rule_defaults: '载入示例规则',
    group_rule_remove: '删除',
    group_name: '分组名',
    group_pattern: '匹配规则（前缀或正则）',
    group_rules_empty: '暂无规则；开关打开且无匹配时不分组',
