...
export default {
  ...
  workflow: {
    ...
    group_source_prefix: 'Prefix',
    relation_biz_group: 'Business group',
    relation_title: 'Workflow Dependency Analysis',
    relation_subtitle: 'Explore topology and timeline. Lanes follow dependency depth for any project.',
  ...
  preference: {
    group_rules_title: 'Workflow group rules',
    group_rules_hint: 'Auto-group by name pattern. Manual [group:xxx] in description overrides rules.',
    group_manual_hint: 'Manual override: put [group:ops] or #group:ops in the workflow description.',
    ...
    group_rules_empty: 'No rules — fallback to name prefix',
