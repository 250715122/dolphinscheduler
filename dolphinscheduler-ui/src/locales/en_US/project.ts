...
export default {
  ...
  workflow: {
    ...
    view_by_group: 'Grouped',
    view_as_list: 'List',
    batch_group: 'Batch Group',
    batch_group_placeholder: 'Select an existing group, or type a new name and press Enter',
    batch_group_required: 'Please select or enter a business group',
    batch_group_empty: 'Please select workflows first',
    batch_group_tip: 'Assign selected workflows to a business group (pick existing or create new)',
    schedule_none: 'No schedule',
    reset: 'Reset',
    query: 'Query',
    group_source_manual: 'Manual',
    group_source_rule: 'Rule',
    group_source_prefix: 'Name prefix',
    ungrouped: 'Ungrouped',
    relation_biz_group: 'Business group',
    relation_no_permission_title: 'No project access',
    relation_no_permission_desc: 'You are not authorized to view workflow relations for this project.',
    relation_close: 'Close',
    relation_title: 'Workflow dependencies',
    relation_external_edge: 'Cross-project · {project}',
    relation_external_short: 'Other project: {project}',
    relation_external_project: 'Other project',
    relation_focus_hint: 'Double-click a node to focus its neighborhood',
    relation_toggle_filter: 'Filters',
    relation_fit_view: 'Fit view',
    relation_depth_3: '3-hop neighborhood',
    relation_publish_status: 'Publish status',
    relation_impact_summary: 'Upstream {up} · Downstream {down}',
    relation_impact_hint: 'Select a workflow on the topology or timeline to see full upstream/downstream impact.',
    relation_view_impact: 'Impact',
    relation_mode_lineage_soon: 'Table-level lineage is coming; this page currently focuses on workflow dependencies.',
    relation_mode_hybrid: 'Hybrid',
    relation_mode_lineage: 'Data lineage',
    relation_mode_workflow: 'Workflow deps',
    relation_subtitle: 'Explore topology, schedules, upstream/downstream and blast radius',
    relation_filter_collapse: 'Collapse',
    relation_filters: 'Filters',
    relation_search: 'Search',
    relation_prefix: 'Name prefix',

    relation_level: 'Dependency level',
    relation_level_root: 'roots',
    relation_timeline_axis: 'Time of day',
    relation_timeline_no_cron: 'No schedule',
    relation_layer: 'Name prefix',
    relation_status: 'Status',
    relation_depth: 'Relation depth',
    relation_depth_self: 'Self only',
    relation_depth_1: '1-hop',
    relation_depth_2: '2-hop',
    relation_depth_all: 'Full lineage',
    relation_only_isolated: 'Isolated only',
    relation_detail: 'Workflow detail',
    relation_detail_empty: 'Select a workflow to inspect upstream/downstream impact.',
    relation_basic: 'Basics',
    relation_upstream: 'Upstream',
    relation_downstream: 'Downstream',
    relation_none: 'None',
    relation_actions: 'Actions',
    relation_goto_definition: 'Open definition',
    relation_goto_instances: 'Open instances',
    relation_goto_impact: 'Impact analysis',
    relation_back_detail: 'Back to detail',
    relation_view_topology: 'Topology',
    relation_view_timeline: 'Timeline',
    relation_metric_nodes: 'Workflows',
  ...
  node: {
    ...
    sql_check_name: 'Check name',
    sql_check_name_tips: 'Optional label for alerts/list',
    sql_check_sql: 'Comparison SQL (one numeric cell)',
    sql_check_operator: 'Fail-when operator',
    sql_check_threshold: 'Threshold',
    sql_check_threshold_tips: 'Task fails when actual operator threshold is true',
    sql_check: 'SQL Check',
  ...
  preference: {
    cancel: 'Cancel',
    group_color: 'Color',
    group_color_preset_hint: 'Pick from 8 preset colors for consistency',
    group_catalog_title: 'Business groups',
    submit_task_only_hint: 'Submit above only saves task defaults (priority, tenant, worker, etc.)',
    group_save_failed: 'Failed to save business group settings',
    group_saved: 'Business group settings saved',
    group_autosave_hint: 'Group settings save immediately',
    group_saving: 'Saving…',
    group_auto_match_hint: 'Applies only to workflows without a manual group. When off, those show as ungrouped.',
    group_auto_match_off: 'Off',
    group_auto_match_on: 'On',
    group_auto_match_label: 'Enable auto-match',
    group_catalog_hint: 'CRUD business groups for this project. Manual assignment and matching rules reference these names. Priority: manual → rules → name prefix.',
    group_catalog_empty: 'No groups yet — add one or load samples',
    group_add: 'Add group',
    group_edit: 'Edit',
    group_load_defaults: 'Load sample groups',
    group_sync_done: 'Synced, {n} groups in total',
    group_sync_existing: 'Sync existing names',
    group_search: 'Search name / description',
    group_desc: 'Description',
    group_desc_placeholder: 'Optional note',
    group_actions: 'Actions',
    group_name_required: 'Group name is required',
    group_name_duplicate: 'Group name already exists',
    group_delete_confirm_title: 'Delete group',
    group_delete_confirm: 'Delete group "{name}"? Related rules and manual overrides will be cleared.',
    group_rules_need_catalog: 'Create business groups above before adding rules',
    group_rules_title: 'Auto-match rules',
    group_rules_hint: 'When on: unmatched workflows are grouped by rules below. When off: no manual group means ungrouped. Changes save immediately.',
    group_manual_hint: 'Manual: (1) Batch group on workflow list; (2) [group:ops] or #group:ops in description.',
    group_rule_add: 'Add rule',
    group_rule_defaults: 'Load sample rules',
    group_rule_remove: 'Remove',
    group_name: 'Group',
    group_pattern: 'Pattern (prefix or regex)',
    group_rules_empty: 'No rules; with switch on and no match, workflows stay ungrouped',
