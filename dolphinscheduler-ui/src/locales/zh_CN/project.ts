...
export default {
  ...
  workflow: {
    ...
    reset: '重置',
    query: '查询',
    group_source_manual: '手动标记',
    group_source_rule: '规则匹配',
    group_source_prefix: '名称前缀',
    relation_biz_group: '业务分组',
    relation_title: '工作流依赖分析',
    relation_subtitle: '看全局、查单点、追链路、看时间。按依赖拓扑分层展示，适用于任意项目。',
  ...
  preference: {
    group_rules_title: '工作流分组规则',
    group_rules_hint: '按名称匹配规则自动归组；优先级低于描述中的手动标记 [group:xxx]。',
    group_manual_hint: '手动覆盖：在工作流定义的「描述」中写入 [group:运维] 或 #group:运维。',
    group_rule_add: '新增规则',
    group_rule_defaults: '载入示例规则',
    group_rule_remove: '删除',
    group_name: '分组名',
    group_pattern: '匹配规则（前缀或正则）',
    group_rules_empty: '暂无规则，将回退到名称前缀分组',
